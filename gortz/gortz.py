...
from gortz import version
from gortz.example import hello
...
app = typer.Typer(
    name="gortz",
    help="Awesome `gortz` is a Python cli/package created with https://github.com/TezRomacH/python-package-template",
...
def version_callback(print_version: bool) -> None:
    ...
    if print_version:
        console.print(f"[yellow]gortz[/] version: [bold blue]{version}[/]")
        raise typer.Exit()
